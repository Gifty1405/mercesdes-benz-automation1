...
public class GenericWebSTeps {
    ...
    public void clickAgreeButton() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='ag-1730825773216']")));
    ...
    public void selectState() {
        // to write code for slecting "south wales" from drop down list.
    }
    ...
    public  void clickSpeakToExpertBtn() {
        driver.findElement(By.xpath("//button[span[contains(normalize-space(), 'Speak to an Expert')]]")).click();
    }
